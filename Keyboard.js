//Create keyboard object for easy deployment
var Keyboard = function(){
  var self = this;
//creates the actual way to detect actions from the keyboard
//(without both this code would be useless)
  ...
  //keyboard keycodes (thanks ajani :) )
